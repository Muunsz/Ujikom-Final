...
try {
    $stmt = $pdo->prepare("
    SELECT s.*, s.foto, na.*, e.nama AS nama_ekstrakurikuler, e.nilai AS nilai_ekstrakurikuler, 
...
<body>
    <div class="container">
        ...
        <?php if (!empty($raport['foto'])): ?>
            <div class="student-photo">
                <img src="<?php echo htmlspecialchars($raport['foto']); ?>" alt="Foto <?php echo htmlspecialchars($raport['nama']); ?>" style="max-width: 200px; border-radius: 10px; margin-bottom: 20px;">
            </div>
        <?php endif; ?>
        <h3>Data Siswa</h3>
